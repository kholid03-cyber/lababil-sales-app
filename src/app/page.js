          ...
          <div className="flex justify-between items-center h-16">
            <div className="flex items-center">
              <div className="bg-gradient-to-r from-blue-600 to-blue-700 text-white p-2 rounded-lg mr-3 flex items-center justify-center">
                {/* Updated Lababil Solution Logo SVG - L containing B */}
                <svg width="24" height="18" viewBox="0 0 400 300" className="text-white">
                  <defs>
                    ...
                    <linearGradient id="silverGradHeader" x1="0%" y1="0%" x2="100%" y2="100%">
                  ...
                  <path d="M50 50 L50 150 L150 150 L150 130 L70 130 L70 50 Z" fill="url(#blueGradHeader)" stroke="currentColor" strokeWidth="1"/>
                  
                  {/* Letter B (3D Silver) - Inside the L */}
                  {/* Main vertical bar of B */}
                  <path d="M78 55 L78 115 L98 115 L98 55 Z" fill="url(#silverGradHeader)"/>
                  
                  {/* Top horizontal section of B */}
                  <path d="M78 55 L118 55 Q125 55 125 65 Q125 72 120 75 Q115 77 110 77 L78 77 Z" fill="url(#silverGradHeader)"/>
                  
                  {/* Middle divider */}
                  <path d="M78 77 L108 77 L108 83 L78 83 Z" fill="url(#silverGradHeader)"/>
                  
                  {/* Bottom horizontal section of B */}
                  <path d="M78 83 L130 83 Q145 83 145 100 Q145 110 140 115 Q135 115 125 115 L78 115 Z" fill="url(#silverGradHeader)"/>
                  ...
                  <circle cx="115" cy="100" r="8" fill="none" stroke="url(#silverGradHeader)" strokeWidth="1.5"/>
                  
                  {/* Camera lens inner circle */}
                  <circle cx="115" cy="100" r="5" fill="url(#blueGradHeader)"/>

export const generateSalesReportHTML = (sales, dateRange, companyInfo) => {
  ...
  // Lababil Solution watermark logo (same as receipt)
  const watermarkLogo = `data:image/svg+xml;base64,${btoa(`
    <svg width="200" height="120" viewBox="0 0 200 120" xmlns="http://www.w3.org/2000/svg">
      ...
      <!-- L Shape -->
      <rect x="20" y="20" width="25" height="60" fill="url(#blueGrad)"/>
      <rect x="20" y="65" width="40" height="15" fill="url(#blueGrad)"/>
      <!-- B Shape with camera lens -->
      <rect x="70" y="20" width="25" height="60" fill="url(#blueGrad)"/>
      <rect x="70" y="20" width="35" height="15" fill="url(#blueGrad)"/>
      <rect x="70" y="42" width="30" height="12" fill="url(#blueGrad)"/>
      <rect x="70" y="65" width="35" height="15" fill="url(#blueGrad)"/>
      <!-- Camera lens circle -->
      <circle cx="125" cy="50" r="15" fill="none" stroke="url(#blueGrad)" stroke-width="3"/>
      <circle cx="125" cy="50" r="8" fill="url(#blueGrad)"/>
      <!-- Text -->
      <text x="20" y="100" font-family="Arial, sans-serif" font-size="16" font-weight="bold" fill="url(#blueGrad)">LABABIL</text>
      <text x="20" y="115" font-family="Arial, sans-serif" font-size="12" fill="url(#blueGrad)">SOLUTION</text>
    </svg>
  `)}`;
